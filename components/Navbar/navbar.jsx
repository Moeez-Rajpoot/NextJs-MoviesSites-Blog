...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-[#101010] sticky top-0 right-0 z-10 w-full h-14 flex border-b-[1px] border-white border-opacity-20 ">
        {issearch && (
          <div className="fixed top-0 z-40 right-0 overflow-y-hidden w-screen h-screen bg-[#333232] opacity-90">
            <div
