...
export default function bar() {
  return (
    <div className=" relative h-14 flex w-full sm:w-[90%] lg:w-[72%] mb-96">
      ...
      <div className="w-full sm:w-1/2  lg:w-[33.33%] h-full flex justify-between lg:justify-center items-center">
        <div className="flex items-center ml-3 sm:ml-0 text-white hover:cursor-pointer  hover:text-red-700 justify-center h-full">
          ...
          <div className="px-2 py-[2px] font-bold text-xs ml-1 rounded-full bg-gray-600">
            1
          </div>
        </div>
      ...
      <div className="w-[33.33%] hidden lg:block  h-full">
        <div className="flex gap-1 justify-end mr-1 items-center h-full">
          <p className="font-bold text-sm hover:cursor-pointer hover:underline ">Sign In Into Your <span className="text-red-700">MUO</span> Account</p>
